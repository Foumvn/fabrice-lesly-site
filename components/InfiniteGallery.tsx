...
const createClothMaterial = () => {
	return new THREE.ShaderMaterial({
      ...
      void main() {
        ...
        float ripple1 = sin(pos.x * 6.0 + scrollForce * 3.0) * 0.02;
        float ripple2 = sin(pos.y * 7.5 + scrollForce * 2.0) * 0.015;
        ...
        float wavePhase = pos.x * 10.0 + time * 8.0;
        ...
        float secondaryWave = sin(pos.x * 15.0 + time * 12.0) * 0.03 * dampening;
